  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div
        ...
        className="relative items-center justify-center top-20 bottom-10 cursor-pointer transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-xl active:scale-95 active:shadow-md"
      >
        <CardStack title={cardData.title} imageUrl={cardData.imageUrl} />
      </div>
